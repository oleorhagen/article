...
\title{The Development of the RRT-Funnel Algorithm for\\ IEEE
...
Kim Mathiassen\IEEEauthorrefmark{2}, and
Marius Thoresen\IEEEauthorrefmark{3}}
...
% Workaround acronyms incompatibility with IEEE
\renewcommand{\IEEEiedlistdecl}{\IEEEsetlabelwidth{S ONET}}
\begin{acronym}[TDMA]
