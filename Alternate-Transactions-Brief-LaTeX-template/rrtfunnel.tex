...
\begin{document}
\title{The Rapidly exploring Random Tree Funnel Algorithm for IEEE TRANSACTIONS and JOURNALS (February 2017)}
\author{Ole Petter Orhagen, \IEEEmembership{Fellow, IEEE}, Marius Thoresen, and
