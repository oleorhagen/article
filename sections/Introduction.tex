\section{Review of SOS-Programming}
...
\begin{figure}
  ...
  \centering { \fontsize{12pt}{12pt}\selectfont \def\svgwidth{.8\columnwidth}
...
The \textit{S-procedure} is used in this paper to check for positivity for the
