...
The results from the given simulations are summarized using the performance
measures number of collisions, the total length of the solution trajectories,
and the number of branches added to each search tree. These perfomance measures
are shown in \cref{table:results}, \cref{table:results-length}
...
simulations runs that had a collision is given, while in the later two tables an
average of the hundred simulation rund are given.
