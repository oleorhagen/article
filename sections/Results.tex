...
table \cref{table:results}, and shows the number of collisions, the total length
of the solution trajectories, and the number of branches added to each search
tree over a total of hundred simulation runs for each column. It is seen that
the \rrtfunnel{} algorithm performs better in terms of robustness up to and
