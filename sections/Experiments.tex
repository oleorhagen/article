...
compose acccording to this definition in the experiments run, and the composition
...
framework can be expanded with this functionality however, but this is
...
\kma{Hvis dette er generelt så bør det nok flyttes til metode-delen. Synes det virket gnaske generelt.}
