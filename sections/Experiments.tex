...
a crosswind of \(0\) \IEEEunit{m/s} in the first experiment, in order to set up
a experiment baseline. Second a run with a crosswind of \(0.3\) \IEEEunit{m/s},
...
not doing it. Lastly, an experiment with a \(0.6\) \IEEEunit{m/s} is done, to
