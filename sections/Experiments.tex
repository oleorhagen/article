...
\begin{figure}[!t]
  ...
  \caption{Tree only.}
  \end{subfigure}
  \caption[The expansion of the \rrtfunnel algorithm at 1, and 101 iterations]{Visualized is the expansion of the \rrtfunnel~algorithm at 101 iterations of the algorithm. Both axis dimens are in meters.}
\end{figure}
