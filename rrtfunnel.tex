...
% Need this in order to remove linebreak of table captions.
\usepackage{etoolbox}
\makeatletter
...
%% \author{\IEEEauthorblockN{Ole Petter Orhagen,
%%     Marius Thoresen,~\IEEEmembership{Student Member,~IEEE} and,
%%     Kim Mathiassen,~\IEEEmembership{Member,~IEEE}
%%   }}
...
\author{\IEEEauthorblockN{1\textsuperscript{st} Ole Petter Orhagen}
  \IEEEauthorblockA{\textit{Department of Physics} \\
\textit{University of Oslo}\\
Oslo, Norway \\
olepor@matnat.uio.no }
\and
\IEEEauthorblockN{2\textsuperscript{nd} Marius Thoresen}
\IEEEauthorblockA{\textit{Defence Systems Division} \\
  \textit{Norwegian Defence Research Establishment, FFI}\\
Kjeller, Norway \\
marius.thoresen@ffi.no }
\and
\IEEEauthorblockN{2\textsuperscript{nd} Kim Mathiassen}
\IEEEauthorblockA{\textit{Dept. Technology Systems, University of Oslo} \\
  \textit{Norwegian Defence Research Establishment, FFI}\\
  Kjeller, Norway \\
